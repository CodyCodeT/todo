...
::-webkit-scrollbar-thumb:hover {
    background: #555;
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;AACA;IACI,iCAAiC;IACjC,yBAAyB;AAC7B;AACA;IACI,aAAa;IACb,8BAA8B;IAC9B,iCAAiC;IACjC,WAAW;IACX,aAAa;AACjB;AACA;IACI,eAAe;IACf,YAAY;IACZ,YAAY;IACZ,6BAA6B;IAC7B,iDAAiD;IACjD,aAAa;IACb,sBAAsB;IACtB,aAAa;IACb,oBAAoB;IACpB,kBAAkB;;AAEtB;AACA;IACI,aAAa;IACb,WAAW;IACX,wBAAwB;IACxB,aAAa;IACb,gCAAgC;IAChC,2CAA2C;IAC3C,aAAa;IACb,qBAAqB;IACrB,mBAAmB;AACvB;AACA;IACI,eAAe;IACf,YAAY;IACZ,WAAW;IACX,WAAW;IACX,YAAY;IACZ,kBAAkB;IAClB,mBAAmB;IACnB,cAAc;IACd,eAAe;IACf,YAAY;IACZ;QACI,eAAe;QACf,mBAAmB;IACvB;AACJ;AACA;IACI,wBAAwB;IACxB,aAAa;IACb,YAAY;IACZ,kBAAkB;IAClB,8DAA8D;IAC9D,aAAa;IACb,2DAA2D;IAC3D,0DAA0D;IAC1D,cAAc;AAClB;AACA;IACI,eAAe;IACf,WAAW;IACX,SAAS;IACT,YAAY;IACZ,YAAY;IACZ,iBAAiB;IACjB,cAAc;IACd,eAAe;IACf,YAAY;IACZ;QACI,eAAe;IACnB;AACJ;AACA;IACI,eAAe;IACf,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,8BAA8B;IAC9B,UAAU;AACd;AACA;IACI,YAAY;IACZ,iBAAiB;IACjB,mBAAmB;IACnB,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,8BAA8B;IAC9B,mBAAmB;AACvB;AACA;IACI,WAAW;IACX,kBAAkB;IAClB,YAAY;IACZ,gCAAgC;IAChC,eAAe;IACf,aAAa;IACb;QACI,aAAa;IACjB;AACJ;AACA;IACI,YAAY;IACZ,YAAY;IACZ,YAAY;IACZ,mBAAmB;IACnB,mBAAmB;IACnB,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB;QACI,eAAe;QACf,mBAAmB;IACvB;AACJ;AACA;IACI,WAAW;IACX,YAAY;IACZ,YAAY;IACZ,eAAe;IACf,aAAa;IACb;QACI,aAAa;IACjB;AACJ;AACA;IACI,WAAW;IACX,YAAY;IACZ,YAAY;IACZ,gCAAgC;IAChC,eAAe;IACf,aAAa;IACb;QACI,aAAa;IACjB;AACJ;AACA;IACI,WAAW;IACX,aAAa;IACb,YAAY;IACZ,gCAAgC;IAChC,aAAa;IACb,gBAAgB;IAChB;QACI,aAAa;IACjB;;AAEJ;AACA;IACI,kBAAkB;IAClB,oBAAoB;IACpB,aAAa;;IAEb,aAAa;IACb,sBAAsB;IACtB,8BAA8B;IAC9B,mBAAmB;IACnB,mBAAmB;IACnB,yBAAyB;AAC7B;AACA;IACI,gBAAgB;IAChB,YAAY;IACZ,mBAAmB;IACnB,gBAAgB;IAChB,YAAY;;IAEZ;QACI,eAAe;QACf,mBAAmB;IACvB;AACJ;AACA;IACI,WAAW;AACf;AACA;IACI,gBAAgB;AACpB;AACA;IACI,gBAAgB;AACpB","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\nbody {\n    font-family: 'Roboto', sans-serif;\n    background-color: #c1c1c1;\n}\n#container {\n    display: grid;\n    grid-template-rows: 200px auto;\n    grid-template-columns: 250px auto;\n    width: 100%;\n    height: 100vh;\n}\n#sidebar {\n    position: fixed;\n    width: 250px;\n    height: 100%;\n    /* height: calc(100%-50px); */\n    background: linear-gradient(#ffffff, white 40px) ;\n    display: flex;\n    flex-direction: column;\n    padding: 20px;\n    padding-bottom: 80px;\n    overflow-y: scroll;\n    \n}\n#header {\n    height: 200px;\n    width: 100%;\n    grid-area: 1 / 2 / 3 / 3;\n    padding: 20px;\n    border-bottom: 1px solid #e0e0e0;\n    box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.3);\n    display: flex;\n    justify-content: left;\n    align-items: center;\n}\n#newtodo {\n    position: fixed;\n    bottom: 20px;\n    right: 20px;\n    width: 50px;\n    height: 50px;\n    border-radius: 50%;\n    background: #02d0b1;\n    color: #ffffff;\n    font-size: 30px;\n    border: none;\n    &:hover {\n        cursor: pointer;\n        background: #02a88f;\n    }\n}\n#todos {\n    grid-area: 1 / 2 / 3 / 3;\n    padding: 20px;\n    height: 200%;\n    overflow-y: scroll;\n    background-image: linear-gradient(to bottom, #ffffff, #000000);\n    display: grid;\n    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr));\n    grid-template-rows: repeat(auto-fit, minmax(250px, 350px));\n    grid-gap: 20px;\n}\n#newproject {\n    position: fixed;\n    bottom: 0px;\n    left: 0px;\n    height: 50px;\n    width: 250px;\n    background: white;\n    color: #707070;\n    font-size: 20px;\n    border: none;\n    &:hover {\n        cursor: pointer;\n    }\n}\n#formcontainer {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    display: none;\n    justify-content: center;\n    align-items: center;\n    background: rgba(0, 0, 0, 0.5);\n    z-index: 1;\n}\n#formcontainer>form {\n    width: 500px;\n    background: white;\n    border-radius: 15px;\n    padding: 20px;\n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n}\n#formcontainer>form>input {\n    width: 100%;\n    /* height: 50px; */\n    border: none;\n    border-bottom: 1px solid #707070;\n    font-size: 20px;\n    padding: 10px;\n    &:focus {\n        outline: none;\n    }\n}\n#formcontainer>form>button {\n    width: 100px;\n    height: 50px;\n    border: none;\n    border-radius: 15px;\n    background: #02d0b1;\n    color: white;\n    font-size: 20px;\n    margin-top: 10px;\n    &:hover {\n        cursor: pointer;\n        background: #02a88f;\n    }\n}\n#formcontainer>form>label {\n    width: 100%;\n    height: 50px;\n    border: none;\n    font-size: 20px;\n    padding: 10px;\n    &:focus {\n        outline: none;\n    }\n}\n#formcontainer>form>select {\n    width: 100%;\n    height: 50px;\n    border: none;\n    border-bottom: 1px solid #707070;\n    font-size: 20px;\n    padding: 10px;\n    &:focus {\n        outline: none;\n    }\n}\n#description {\n    width: 100%;\n    height: 100px;\n    border: none;\n    border-bottom: 1px solid #707070;\n    padding: 10px;\n    font-size: 1.5em;\n    &:focus {\n        outline: none;\n    }\n\n}\n.todobox {\n    /* width: 450px; */\n    /* height: 300px;s */\n    padding: 15px;\n    \n    display: flex;\n    flex-direction: column;\n    justify-content: space-between;\n    align-items: center;\n    border-radius: 15px;\n    background-color: #c1c1c1;\n}\n.sidebarelement {\n    background: none;\n    border: none;\n    margin-bottom: 15px;\n    text-align: left;\n    padding: 5px;\n\n    &:hover {\n        cursor: pointer;\n        background: #dadada;\n    }\n}\n::-webkit-scrollbar {\n    width: 10px;\n}\n::-webkit-scrollbar-thumb {\n    background: #888;\n}\n::-webkit-scrollbar-thumb:hover {\n    background: #555;\n}"],"sourceRoot":""}]);
// Exports
...
function todoLoader(projectListArray, i) {
  ...
  for (let j = 0; j < projectListArray[i].todos.length; j++) {
    ...
    dueDate.textContent = `Due on ${(0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(due, 'MMM-d-yy')} ${(0,date_fns_formatDistance__WEBPACK_IMPORTED_MODULE_3__["default"])(today, due)}`
...
/* harmony import */ var _todoFactory_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./todoFactory.js */ "./src/todoFactory.js");
...
newTodoForm.addEventListener("click", function () {
  (0,_todoForm_js__WEBPACK_IMPORTED_MODULE_1__["default"])(projectListArray);
